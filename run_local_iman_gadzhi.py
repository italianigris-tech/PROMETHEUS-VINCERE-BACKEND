...
VIDEO = "/home/ec2-user/PROMETHEUS-CORE-BACKEND/RAW HEAD VIDS PINTEREST/IMAN GADZHI TALKING HEAD.mp4"
...
def main():
    ...
    payload = {
        "jobId": job_id,
        "source": {"path": VIDEO},
        "metadata": {"pipeline": "minirun", "jobName": "iman_gadzhi"},
        "design": {
            "aspectRatio": "9:16",
            ...
            "pipPolicy": "disabled",
            "motif": "royal_amethyst",  # Cohesive purple/white brand motif resonance
            "listicleTreatment": "gradient_fade_oblivion",
        },
        "audio": {"songPolicy": "auto"},
        "selectedWindow": {"sourceStartMs": 0, "sourceEndMs": 30000},
    }
    print("=== STARTING LOCAL IMAN GADZHI 30s MINI-RUN ===", flush=True)
