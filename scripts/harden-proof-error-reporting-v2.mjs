...
try { unlinkSync(path.resolve(root, "scripts/harden-proof-error-reporting.mjs")); } catch {}
unlinkSync(path.resolve(root, "scripts/harden-proof-error-reporting-v2.mjs"));
