          ...
          return [{
            ...
            phases: {
              entry: {
                ...
                from: frameMotion.phases.entry.from,
                to: frameMotion.phases.entry.to,
              },
              hold: {
                ...
                from: frameMotion.phases.hold.from,
                to: frameMotion.phases.hold.to,
              },
              exit: {
                ...
                from: frameMotion.phases.exit.from,
                to: frameMotion.phases.exit.to,
              },
            },
