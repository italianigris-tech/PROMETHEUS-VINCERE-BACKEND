...
export const JOSEPH_BACKGROUND_PRIMITIVE_CATALOG: readonly JosephBackgroundPrimitiveDefinition[] = [
  ...
  {
    primitiveId: "gobo.ambient-shadow-drift",
    label: "Ambient Shadow Gobo",
    family: "shader_background",
    role: "atmosphere",
    layer: "atmosphere",
    blendMode: "multiply",
    ...
    profileAffinity: ["joseph_cinematic", "joseph_minimal"],
    densityAffinity: ["low", "medium"],
    defaultParameters: params("neutral_contrast", 0.32, 0.28, 0.12, 0.08, 0.58, 0.36, 0.25),
  },
  {
    primitiveId: "spatial.hierarchical-hero-quad",
    label: "Hierarchical Spatial Hero Quad",
    family: "editorial_backplate",
    role: "backplate",
    layer: "overlay_support",
    blendMode: "soft_light",
    ...
    profileAffinity: ["joseph_cinematic", "joseph_minimal"],
    densityAffinity: ["medium", "high"],
    defaultParameters: params("neutral_contrast", 0.12, 0.16, 0.24, 0.04, 0.76, 0.48, 0.70),
  },
  {
    primitiveId: "canvas.continuous-vertical-descent",
    label: "Continuous Spatial Canvas Descent",
    family: "shader_background",
    role: "background",
    layer: "foundation",
    blendMode: "normal",
    doctrineAffinity: ["kinetic-pulse", "spotlight-swap"],
    profileAffinity: ["joseph_cinematic", "joseph_aggressive"],
    densityAffinity: ["medium", "high"],
    defaultParameters: params("cinematic_cool", 0.35, 0.24, 0.22, 0.14, 0.64, 0.52, 0.88),
  },
  {
    primitiveId: "optics.attention-gated-bokeh",
    label: "Attention-Gated Bokeh Defocus",
    family: "focus_tunnel",
    role: "background",
    layer: "foundation",
    blendMode: "overlay",
    ...
    profileAffinity: ["joseph_cinematic", "joseph_minimal", "joseph_aggressive"],
    densityAffinity: ["low", "medium", "high"],
    defaultParameters: params("cinematic_cool", 0.28, 0.18, 0.44, 0.22, 0.60, 0.46, 0.75),
  },
  {
    primitiveId: "retinal.micro-flash-inversion",
    label: "Single-Frame Retinal Inversion Flash",
    family: "accent_geometry",
    role: "accent",
    layer: "accent",
    blendMode: "screen",
    ...
    profileAffinity: ["joseph_aggressive", "joseph_cinematic"],
    densityAffinity: ["high"],
    defaultParameters: params("electric_blue", 0.95, 0.10, 0.85, 0.30, 0.90, 0.60, 0.92),
  },
];
